...
const InitialInfo = () => {
  ...
  return (
    <div className="lg:h-screen container_layout bg-hero-pattern bg-no-repeat bg-left bg-contain bg-opacity-5 py-3">
      ...
      <div className="w-full h-1/2 lg:pt-32 flex flex-col lg:flex-row justify-center items-center lg:justify-evenly container  pt-10 text-white">
        <div className="w-full lg:w-4/5  items-center ">
          ...
          <p className="w-full text-center lg:text-left py-5 text-2xl lg:w-4/5 ">
            Sou um profissional apaixonado por tecnologia e desenvolvimento de
            softwares.
          </p>
        </div>
